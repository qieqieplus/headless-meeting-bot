...
export CGO_LDFLAGS="-L${BUILD_LIB} -lzoombot_c -Wl,-rpath,${BUILD_LIB} -Wl,-rpath,${SDK_LIB} -Wl,-rpath,${QT_LIB} -Wl,-rpath-link,${SDK_LIB} -Wl,-rpath-link,${QT_LIB} -Wl,-rpath-link,${BUILD_LIB}"
