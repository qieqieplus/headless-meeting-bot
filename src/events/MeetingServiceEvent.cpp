...
MeetingServiceEvent::MeetingServiceEvent(std::function<void()> onJoin,
                                         std::function<void()> onEnd)
    : m_onMeetingJoin(onJoin), m_onMeetingEnd(onEnd) {}
void MeetingServiceEvent::onMeetingStatusChanged(ZOOMSDK::MeetingStatus status,
                                                 int iResult) {
...
void MeetingServiceEvent::onMeetingFullToWatchLiveStream(
